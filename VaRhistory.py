...
def VaRwithoutmc():
    ...
    st.markdown("###### Tips: We have 3 inputs to run this app. First we need at least two companies  stock symbol(stock symbol can be found in yahoo finance website)")
    st.markdown("###### Tips: Next, we need the desired weights to calculate the portfolio..")
